...
| Catch me if you can: performance bug detection in the wild   | 2011         | **Private**          | [laghunter](https://sape.inf.usi.ch/laghunter/) **can't be accessed now** | dynamic analysis                               |
...
| Detecting Missing-Permission-Check Vulnerabilities in Distributed Cloud Systems | 2022         | **Private**          | **None**(does not explicitly mention that its code is open-source.) | static analysis                                |
